...
namespace WebApp.Demo.Course.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id, byte[] rowVersion)
        {
            ...
            var deparmentToUpdate = await _context.Departments
                .Include(x => x.Administrator)
                .FirstOrDefaultAsync(x => x.DepartmentID == id);
            ...
            if (deparmentToUpdate == null)
            {
                ...
                ModelState.AddModelError(string.Empty,
                    "Unable to save changes. The deparment was deleted by another user");
            ...
            _context.Entry(deparmentToUpdate).Property("RowVersion").OriginalValue = rowVersion;
                ...
                catch (DbUpdateConcurrencyException ex)
                {
                    ...
                    else
                    {
                     ...
                     + "the Save button again. Otherwise click the Back to List hyperlink.");
                        ...
                        deparmentToUpdate.RowVersion = (byte[])databaseValues.RowVersion;
            ...
            ViewData["InstructorID"] = new SelectList(_context.Instructors, "ID", "FullName", deparmentToUpdate.InstructorID);
            return View(deparmentToUpdate);
        }
        ...
        public async Task<IActionResult> Delete(Department department)
        {
            try
            {
                if (await _context.Departments.AnyAsync(x => x.DepartmentID == department.DepartmentID))
                {
